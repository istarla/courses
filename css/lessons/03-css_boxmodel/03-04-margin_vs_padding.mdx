...
1.**Adjacent Siblings:**
   ...
   of the next block sibling element.
            ...
            <div className="example-outer">
  <div
    className="collapse-box collapse-box1"
    style={{
      marginBottom: "30px",
    }}
  >
  ...
  <div
    className="collapse-box collapse-box2"
    style={{
      marginTop: "20px",
    }}
  >
  ...
  <p className="text-center text-sm mt-2">
    Expected space: 50px. Actual space due to collapse: 30px (max(30px, 20px)).
  </p>
</div>
...
>
  ...
  >
    Parent has margin-top: 0 (from example-outer); Child has margin-top: 25px.
    Collapsed margin is 25px.
  </div>
</div>
...
3.**Empty Blocks:**
  ...
  <p className="text-center text-sm">
    (Invisible collapsed margin between above and below: max(20,25) = 25px)
  </p>
  ...
  <p className="text-center text-sm mt-2">
    Space between Box Before and Box After could be affected by the empty
    block's collapsed margins.
  </p>
</div>
